...
@EventBusSubscriber
public class TerracottaWrappedCopperBlockDestroyedByPlayerProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (new Object() {
			...
			if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == SpcoreModBlocks.TERRACOTTA_WRAPPED_COPPER.get()
				...
				if (world instanceof ServerLevel _level)
					_level.getServer().getCommands().performPrefixedCommand(
							...
							"loot spawn ~ ~ ~ loot survivalpluscore:blocks/terracotta_wrapped_copper");
			}
		}
	}
}
