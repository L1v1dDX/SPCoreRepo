...
@EventBusSubscriber
public class WrappedCopperBlockDestroyedByPlayerProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (new Object() {
			...
			if ((world.getBlockState(BlockPos.containing(x, y, z))) == SpcoreModBlocks.WRAPPED_COPPER.get().defaultBlockState()) {
				if (world instanceof ServerLevel _level)
					_level.getServer().getCommands().performPrefixedCommand(
							...
							"loot spawn ~ ~ ~ loot survivalpluscore:gameplay/wrapped_copper_loot");
			}
		}
	}
}
